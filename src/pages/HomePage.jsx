...
function HomePage({ time }) {
    ...
    return (
        <div className="page">
            ...
            <p>Here at Strange Time, you can find a variety of clocks displaying the current time in different confusing formats! All the clocks use 24hr time format to confuse those of you used to 12hr clocks even more!</p>
