...
function DecimalTimePage({ time }) {
    return (
        <div className="page">
            ...
            <p>So for example, 2:30am would be 2/24 = 0.08 for the hour, 30/60 = 0.50 for the minute, with the total time of 0.08:0.50 (plus the seconds but I think you get the idea)</p>
        </div>
    )
}
